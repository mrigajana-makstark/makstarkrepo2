...
'Consultation'
  ...
  const validateForm = () => {
    const required = ['clientName', 'eventName', 'eventStartDate', 'eventEndDate', 'invoiceDate', 'eventType', 'amount', 'empPointOfContact'];
...
FINANCIAL DETAILS:
Base Amount: ₹${processedData.totalAmount}
Tax (18% GST): ₹${processedData.taxAmount}
Total Amount: ₹${processedData.finalAmount}
