...
export function LandingPage() {
  ...
  const heroImages = [
    'https://images.unsplash.com/photo-1669789748471-81548abdbe8d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWRkaW5nJTIwcGhvdG9ncmFwaHklMjBzZXNzaW9ufGVufDF8fHx8MTc1NzU5ODg5Mnww&ixlib=rb-4.1.0&q=80&w=1080',
    'https://images.unsplash.com/photo-1655828913505-9fb4193d4452?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx2aWRlbyUyMHByb2R1Y3Rpb24lMjBmaWxtaW5nfGVufDF8fHx8MTc1NzU5ODg5Mnww&ixlib=rb-4.1.0&q=80&w=1080',
    'https://images.unsplash.com/photo-1682517254473-174fc5acec2b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjdXN0b20lMjBtZXJjaGFuZGlzZSUyMGJyYW5kaW5nfGVufDF8fHx8MTc1NzU5ODg5M3ww&ixlib=rb-4.1.0&q=80&w=1080'
  ];

  const projects = [
    { id: 1, title: 'Royal Wedding Collection', category: 'Wedding', image: heroImages[0] },
    { id: 2, title: 'Corporate Brand Campaign', category: 'Campaign', image: heroImages[1] },
    { id: 3, title: 'Custom Merch Line', category: 'Merchandise', image: heroImages[2] },
  ];
  ...
  useEffect(() => {
    const animateStats = () => {
      const targetStats = { weddings: 300, campaigns: 50, orders: 1000 };
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center text-white">
            ...
            >
              ...
              <div className="text-blue-100">Brand Campaigns</div>
            </motion.div>
            <motion.div
              initial={{ scale: 0.5, opacity: 0 }}
              whileInView={{ scale: 1, opacity: 1 }}
