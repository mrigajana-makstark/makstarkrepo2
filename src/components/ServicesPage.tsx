  ...
  const services = [
    {
      ...
      icon: Camera,
      image: 'https://ik.imagekit.io/makstark/MS%20WEBSITE/1to2%20(10).JPG?updatedAt=1757604534589',
      ...
      packages: [
        { name: 'Essential', price: '₹20,000', duration: '1 Day' },
        { name: 'Premium', price: '₹40,000', duration: '2 Days' },
        { name: 'Luxury', price: '₹1,00,000', duration: '3 Days' }
      ]
    },
    {
      title: 'Production',
      ...
      icon: Video,
      image: 'https://ik.imagekit.io/makstark/MS%20WEBSITE/cam_5i64gHCbjo?updatedAt=1757683944636',
      ...
      packages: [
        ...
        { name: 'Standard', price: '₹45,000', duration: 'Full Day' },
        { name: 'Premium', price: '₹70,000', duration: 'Multi-Day' }
      ]
    },
    {
      title: 'Customs',
      ...
      icon: Shirt,
      image: 'https://ik.imagekit.io/makstark/MS%20WEBSITE/web.png?updatedAt=1757618724118',
    ...
    },
    {
      ...
      icon: Palette,
      image: 'https://ik.imagekit.io/makstark/MS%20WEBSITE/MAK_0952.JPG?updatedAt=1757507464555',
      ...
      packages: [
        { name: 'Starter', price: '₹10,000', duration: 'Per Month' },
        { name: 'Growth', price: '₹18,000', duration: 'Per Month' },
        { name: 'Enterprise', price: '₹50,000', duration: 'Per Month' }
      ]
    }
  ];
    ...
    <div className="min-h-screen pt-16">
      ...
      <section className="relative h-96 overflow-hidden">
        <div className="absolute inset-0">
          <ImageWithFallback
            src="https://ik.imagekit.io/makstark/MS%20WEBSITE/_MAK3614(1).JPG?updatedAt=1757506636282"
            alt="Services"
