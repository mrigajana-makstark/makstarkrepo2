  ...
  const contactMethods = [
    {
      ...
      value: '+91 81228 02506',
      action: () => {
        const phoneNumber = '+918122802506';
        const message = 'Hi! I would like to know more about Mak Stark services.';
        const whatsappUrl = `https://wa.me/$918653802996?text=${encodeURIComponent(message)}`;
    ...
    },
    {
      ...
      value: 'info.makstark@gmail.com',
      action: () => {
        window.location.href = 'mailto:info.makstark@gmail.com?subject=Project Inquiry';
      },
    ...
    },
    {
      ...
      value: '+91 8653802996',
      action: () => {
        window.location.href = 'tel:+918653802996';
      },
  ...
  const officeInfo = [
    {
      ...
      value: 'Mak Stark,Haldia, West Bengal, India'
    },
    {
      icon: Clock,
      title: 'Working Hours',
