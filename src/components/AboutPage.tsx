...
export function AboutPage() {
    ...
    },
    {
      ...
      image: "https://ik.imagekit.io/makstark/sonia_yr7FXN6Iq?updatedAt=1757683869181"
    }
  ];
    ...
    <div className="min-h-screen pt-16">
      ...
      <section className="relative h-96 overflow-hidden">
        <div className="absolute inset-0">
          <ImageWithFallback
            src="https://ik.imagekit.io/makstark/MS%20WEBSITE/cam_5i64gHCbjo?updatedAt=1757683944636"
            alt="Mak Stark Team"
